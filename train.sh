...
python  tfGan.py --is_decode True \
  ...
  --dis_dev_negative_data './data_val/dev_negative.txt' \
  --dis_dev_positive_data '/home/lerner/data/LCSTS/finished_files/val-abs.txt' \
  --dis_dev_source_data '/home/lerner/data/LCSTS/finished_files/val-art.txt' 
