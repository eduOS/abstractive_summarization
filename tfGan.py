...
tf.app.flags.DEFINE_string('dis_source_data', '/data/zhyang/dl4mt/corpus/data_test1000/source_u8.txt.shuf', 'the negative train data set for the discriminator')

tf.app.flags.DEFINE_string('dis_dev_positive_data', '/data/zhyang/dl4mt/corpus/data_gan_100w_fromZxw/data_for_gan_train_conditional/dev_positive_u8.txt', 'the positive train data set for the discriminator')
tf.app.flags.DEFINE_string('dis_dev_negative_data', '/data/zhyang/dl4mt/corpus/data_gan_100w_fromZxw/data_for_gan_train_conditional/dev_negative_u8.txt', 'the negative train data set for the discriminator')
tf.app.flags.DEFINE_string('dis_dev_source_data', '/data/zhyang/dl4mt/corpus/data_gan_100w_fromZxw/data_for_gan_train_conditional/dev_source_u8.txt', 'the negative train data set for the discriminator')
...
tf.app.flags.DEFINE_string('gan_dis_source_data', '/data/zhyang/dl4mt/corpus/data_gan_100w_fromZxw/data_for_gan_train_conditional/gan_dis_source_u8.txt', 'the positive train data set for the discriminator')
tf.app.flags.DEFINE_string('gan_dis_positive_data', '/data/zhyang/dl4mt/corpus/data_gan_100w_fromZxw/data_for_gan_train_conditional/gan_dis_positive_u8.txt', 'the positive train data set for the discriminator')
tf.app.flags.DEFINE_string('gan_dis_negative_data', '/data/zhyang/dl4mt/corpus/data_gan_100w_fromZxw/data_for_gan_train_conditional/gan_dis_negative_u8.txt', 'the negative train data set for the discriminator')
            ...
            ######################################  pretraining  the generator ######################################################################
                ...
                with tf.variable_scope('second_generate'):
                    ...
                    if is_decode:
                                ...
                                generator.gen_train()
                                generator.build_generate(maxlen=max_len, generate_batch=gan_gen_batch_size, optimizer='rmsprop')
               ...
               #   ####################################### Start Reinforcement Training #######################################################################################
                   if is_gan_train:
                      ...
                      for gan_iter in range(gan_total_iter_num):
                           ...
                           #gen_train_it = gen_train_iter(gan_dis_source_data, gan_gen_reshuffle, generator.dictionaries[0], n_words_src, gan_gen_batch_size, max_len)
                           gen_train_it = gen_force_train_iter(gan_dis_source_data, gan_dis_positive_data, gan_gen_reshuffle, generator.dictionaries[0], generator.dictionaries[1],
                                                               gan_gen_batch_size, max_len, n_words_src, n_words_trg)
                           ...
                           for gen_iter in range(gan_gen_iter_num):
                                ...
                                x, x_mask, y_ground, y_ground_mask = prepare_data(x, y_ground, maxlen=50, n_words_src=n_words_src, n_words=n_words_trg)
                                y_sample_out = generator.generate_step(x, x_mask)

                               ##### for debug to print these generated sentence
                                #y_out, _ = deal_generated_y_sentence(y_sample_out, generator.worddicts)
                                ...
                                rewards = generator.get_reward(x, x_mask, x_to_maxlen, y_input, y_input_mask, roll_num, discriminator, bias_num=bias_num)
                                ...
                                if teacher_forcing:
                                   y_ground = prepare_sentence_to_maxlen(numpy.transpose(y_ground), maxlen=50, precision=precision)
                                   y_ground_mask = prepare_sentence_to_maxlen(numpy.transpose(y_ground_mask), maxlen=50, precision=precision)
                           ...
                           dev_num = prepare_three_gan_dis_dev_data(gan_dis_positive_data, gan_dis_negative_data, gan_dis_source_data, dis_dev_positive_data, dis_dev_negative_data, dis_dev_source_data, 200)
                           print('done!')

                           print('finetune the discriminator begin...')
                           discriminator.train(max_epoch = gan_dis_iter_num, positive_data=gan_dis_positive_data, negative_data=gan_dis_negative_data, source_data=gan_dis_source_data)
